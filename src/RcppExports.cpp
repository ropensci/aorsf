...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::mat& >::type pd_vals(pd_valsSEXP);
    Rcpp::traits::input_parameter< arma::uvec& >::type pd_cols(pd_colsSEXP);
