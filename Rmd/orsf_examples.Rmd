...
bm_scores %>%
 ...
 pivot_longer(cols = surv.graf:time_train, names_to = "measure") %>%
 mutate(
  learner_id = factor(
   learner_id,
   levels = paste('surv', c('aorsf', 'rfsrc', 'ranger'), sep = '.'))
 ) %>%
...
ggsave(
 filename = 'Rmd/orsf_examples_cache/orsf_example_mlr_fig.png',
 device = 'png',
 width = 7,
 height = 4,
 dpi = 300
...
knitr::include_graphics(
 "orsf_examples_cache/orsf_example_mlr_fig.png"
)
