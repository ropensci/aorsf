...
orsf_fit <- function(x, y, n_tree, n_split_, mtry_, leaf_min_events_, leaf_min_obs_, cph_method_, cph_eps_, cph_iter_max_, cph_pval_max_, cph_do_scale_, oobag_pred_, oobag_time_, oobag_eval_every_, oobag_importance_, max_retry_) {
    .Call(`_aorsf_orsf_fit`, x, y, n_tree, n_split_, mtry_, leaf_min_events_, leaf_min_obs_, cph_method_, cph_eps_, cph_iter_max_, cph_pval_max_, cph_do_scale_, oobag_pred_, oobag_time_, oobag_eval_every_, oobag_importance_, max_retry_)
}
...
orsf_pred_uni <- function(forest, x_new, time_dbl, return_risk, compute_median = FALSE) {
    .Call(`_aorsf_orsf_pred_uni`, forest, x_new, time_dbl, return_risk, compute_median)
}

orsf_pred_multi <- function(forest, x_new, time_vec, return_risk, compute_median = FALSE) {
    .Call(`_aorsf_orsf_pred_multi`, forest, x_new, time_vec, return_risk, compute_median)
}
